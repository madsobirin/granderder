...
import { Bath, BadgePercent, BedDouble, Building2, LandPlot } from "lucide-react";
import { defaultPromos } from "@/lib/default-content";

const UnitPromoSection = ({ promos = defaultPromos }) => {
        ...
        <div className="space-y-12">
          {promoItems.map((promo, index) => {
            ...
            return (
              ...
              >
                <div className="w-full md:w-1/2 aspect-4/3 md:aspect-auto md:min-h-[420px] relative overflow-hidden bg-brand-cream/20">
                  <Image
                    src={promo.imageUrl}
                    alt={promo.title}
                    width={1080}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {promo.businessLabel ? (
                      <div className="bg-brand-navy text-white p-4 rounded-2xl border border-brand-navy/20 flex flex-col items-center text-center col-span-2 sm:col-span-1">
                        <span className="text-xl font-bold mb-1">{promo.businessLabel}</span>
